          ...
          <div className="max-w-3xl mx-auto">
            <div className="space-y-12 ">

              {
                ...
                <div
                  key={index}
                  className="timeline-item relative pl-12  before:absolute before:left-0 before:top-0 before:w-[2px] before:h-full before:bg-purple cursor-pointer hover:-translate-y-2 transition-all duration-300"
                >
                  {/** timeline dot */}
                  ...
                  <div className=" bg-dark-300 rounded-2xl p-6 w-full">
