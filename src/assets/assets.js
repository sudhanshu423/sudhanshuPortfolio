...
export const workData = [
  {
    role: "MERN developer Program",
    company: "CETPA Infotech",
    duration: "october 2025 - may 2026",
    description:
      "Leading frontend development , implementing modern frameworks, and experience real-world project.",
    color: "purple"
  },
  {
    ...
    description:
      "Developed and maintained landing pages for various clients, focusing on responsive design and performance optimization.",
    color: "pink"
  },
